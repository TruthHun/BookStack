...
- [ ] 本地化和内网的完整支持（增加intranet配置项，用于内网部署，即无法访问外网的情况下）

## v1.7 升级日志
- [x] 搜索精度控制
- [x] 使用http header中的`Last-Modified`和`If-Modified-Since`，对文档内容请求进行 304 缓存优化
    - [x] 如果文档内容为空，则比进行缓存
...
- [ ] 发布队列
- [ ] 跳转编辑指定文档
- [ ] 文档可折叠，避免编辑大文档，内容太多不好定位
- [ ] 下载文档时，没有错误的时候报错的问题
- [ ] 电子书下载页面，扩展站点页面
- [ ] 搜索结果页，显示书籍电子书下载功能
- [ ] 后台增加一个是否登录才能下载电子书的功能，用以扩大用户的注册数
- [ ] 关闭预览，同样可以浏览保存文档
- [ ] 注释的方式，在编辑文档的时候显示采集的文档源链接，但是HTML不显示
