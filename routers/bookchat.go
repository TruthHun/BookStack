...
func bookChatRouters() {
	...
	beego.Router(prefix+"/api/v1/user/register", &api.CommonController{}, "get:TODO")
	...
	beego.Router(prefix+"/api/v1/book/info", &api.CommonController{}, "get:TODO")
	...
	beego.Router(prefix+"/api/v1/book/lists", &api.CommonController{}, "get:TODO")
	...
	beego.Router(prefix+"/api/v1/banners", &api.CommonController{}, "get:TODO")
}
